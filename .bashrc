...
export TEXMFHOME=${TRUEHOME}/work/hcaidocs/texmf
export BIBINPUTS=${TRUEHOME}/work/hcaidocs/bibliography
...
# settings for Python2.6
#export PYTHONPATH=$ORS_ROOT/lib/python2.6/dist-packages:$ORS_ROOT/lib/python2.6/dist-packages/morse/blender:${PYTHONPATH}
